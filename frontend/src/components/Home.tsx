    ...
    >
      ...
      <section className="max-w-7xl mx-auto px-8 pt-24 pb-32">
        <div className="flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2 text-left">
            <h2 className="font-headline font-medium text-on-surface-variant tracking-widest uppercase text-sm mb-6">
              {t('Smart Crop Recommendation System')}
            </h2>
            <h1 className="font-headline font-extrabold text-7xl md:text-8xl text-primary tracking-tighter mb-8 leading-none">
              KrushiSense
            </h1>
            <p className="font-body text-lg md:text-xl text-on-surface-variant leading-relaxed mb-12">
            ...
            <button 
              onClick={onStart}
              className="bg-primary text-on-primary px-10 py-5 rounded-lg font-headline font-bold text-xl transition-all hover:opacity-90 active:scale-95 flex items-center gap-3 shadow-2xl shadow-primary/10"
            >
              {t('Start Prediction')}
      ...
      <section className="bg-surface-container-low py-32 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            <h3 className="font-headline text-4xl font-bold tracking-tight">{t('Agricultural Intelligence')}</h3>
            <p className="font-body text-on-surface-variant mt-2">{t('Empowering farmers with data-driven decision making.')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
            <div className="md:col-span-3 bg-surface-container-lowest p-10 rounded-xl flex flex-col justify-between min-h-[320px] transition-transform hover:-translate-y-1">
              <div>
                <Brain className="w-10 h-10 mb-6 text-primary" />
                <h4 className="font-headline text-2xl font-bold mb-4">{t('Helps farmers choose the right crop')}</h4>
            ...
            <div className="md:col-span-3 bg-surface-container-lowest p-10 rounded-xl flex flex-col justify-between min-h-[320px] transition-transform hover:-translate-y-1">
              <div>
                <Leaf className="w-10 h-10 mb-6 text-primary" />
                <h4 className="font-headline text-2xl font-bold mb-4">{t('Improves crop productivity')}</h4>
                <p className="font-body text-on-surface-variant leading-relaxed">
                  {t('Maximize your yield by planting what nature intended for your specific geographical and chemical profile.')}
                </p>
              </div>
            </div>
            <div className="md:col-span-2 bg-surface-container-lowest p-10 rounded-xl flex flex-col justify-between min-h-[320px] transition-transform hover:-translate-y-1">
              <div>
                <Clock className="w-10 h-10 mb-6 text-primary" />
                <h4 className="font-headline text-xl font-bold mb-4">{t('Saves time and effort')}</h4>
                <p className="font-body text-sm text-on-surface-variant">
                  {t('Instant analysis eliminates weeks of manual soil testing and guesswork.')}
                </p>
              </div>
            </div>
            <div className="md:col-span-2 bg-primary text-on-primary p-10 rounded-xl flex flex-col justify-between min-h-[320px] transition-transform hover:-translate-y-1">
              <div>
                <Wallet className="w-10 h-10 mb-6 text-on-primary" />
                <h4 className="font-headline text-xl font-bold mb-4">{t('Reduces financial loss')}</h4>
            ...
            <div className="md:col-span-2 bg-surface-container-lowest p-10 rounded-xl flex flex-col justify-between min-h-[320px] transition-transform hover:-translate-y-1">
              <div>
                <MousePointer2 className="w-10 h-10 mb-6 text-primary" />
                <h4 className="font-headline text-xl font-bold mb-4">{t('Easy to use for everyone')}</h4>
                <p className="font-body text-sm text-on-surface-variant">
      ...
      <section className="max-w-7xl mx-auto px-8 py-32">
        <div className="relative w-full h-150 overflow-hidden rounded-xl bg-surface-container">
          <img 
            ...
            referrerPolicy="no-referrer"
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center bg-linear-to-t from-background via-transparent to-transparent">
            <div className="mt-4">
              <h3 className="font-headline text-5xl font-extrabold text-primary mb-6 tracking-tighter">{t('Cultivating the Future')}</h3>
              <p className="font-body text-lg text-on-surface max-w-xl">
