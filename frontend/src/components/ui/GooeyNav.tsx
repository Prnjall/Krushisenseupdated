...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  // Sync activeIndex with initialActiveIndex if it changes from outside
  useEffect(() => {
    ...
    <>
      ...
      <div className="relative" ref={containerRef}>
        <nav className="flex relative z-10" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className="flex list-none p-0 m-0 relative z-[3] font-headline font-bold text-[15px] uppercase tracking-tight"
            style={{
              color: textColor,
            }}
          >
            {items.map((item, index) => (
              ...
              >
                <a
                  ...
                  className="outline-none py-[0.5em] px-[1em] inline-block whitespace-nowrap hover:opacity-80 transition-opacity"
                >
                  {item.label}
                </a>
              </li>
