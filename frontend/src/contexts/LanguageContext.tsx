...
const staticTranslations: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    "7-Day Weather Outlook": "7-दिवसीय मौसम आउटलुक",
    "Rain": "बारिश",
    "High": "उच्च",
    "Low": "निम्न",
    "Weather forecast unavailable": "मौसम पूर्वानुमान अनुपलब्ध",
    "Weather outlook": "मौसम आउटलुक",
    "Disease Detection": "रोग का पता लगाना",
    "AI-Assisted Disease Screening": "एआई-सहायता प्राप्त रोग स्क्रीनिंग",
    "Upload a clear photo of a crop leaf to screen for common diseases.": "सामान्य बीमारियों की जांच के लिए फसल के पत्ते की एक स्पष्ट तस्वीर अपलोड करें।",
    "Select Crop": "फसल चुनें",
    "Upload a leaf image": "पत्ती की छवि अपलोड करें",
    "JPG, PNG or WebP • Maximum 5 MB": "JPG, PNG या WebP • अधिकतम 5 MB",
    "Analyze Crop": "फसल का विश्लेषण करें",
    "Analyzing...": "विश्लेषण हो रहा है...",
    "Drag & drop image here or click to browse": "छवि को यहां खींचें और छोड़ें या ब्राउज़ करने के लिए क्लिक करें",
    "Take a photo": "एक तस्वीर लें",
    "Remove image": "छवि निकालें",
    "Your image is analyzed for this screening request and is not stored by KrushiSense.": "आपकी छवि का विश्लेषण इस स्क्रीनिंग अनुरोध के लिए किया जाता है और इसे कृषिसेंस द्वारा संग्रहीत नहीं किया जाता है।",
    "Please select a supported crop first.": "कृपया पहले एक समर्थित फसल का चयन करें।",
    "File size exceeds 5MB limit.": "फ़ाइल का आकार 5MB की सीमा से अधिक है।",
    "Invalid file type. Please upload a JPG, PNG or WebP image.": "अमान्य फ़ाइल प्रकार। कृपया JPG, PNG या WebP छवि अपलोड करें।",
    "An error occurred during upload. Please try again.": "अपलोड के दौरान एक त्रुटि हुई। कृपया पुन: प्रयास करें।",
    "Plant appears healthy": "पौधा स्वस्थ दिखता है",
    "No common disease was detected by the screening model.": "स्क्रीनिंग मॉडल द्वारा किसी सामान्य बीमारी का पता नहीं चला।",
    "Crop": "फसल",
    "Confidence": "विश्वास",
    "Possible disease detected": "संभावित बीमारी का पता चला",
    "AI screening indicates a possible case of": "एआई स्क्रीनिंग इसके संभावित मामले का संकेत देती है:",
    "Disease": "बीमारी",
    "Unable to determine reliably": "विश्वसनीय रूप से निर्धारित करने में असमर्थ",
    "Please upload a clearer photo showing the affected leaf.": "कृपया प्रभावित पत्ते को दिखाते हुए एक स्पष्ट तस्वीर अपलोड करें।",
    "Suggestions for better results:": "बेहतर परिणामों के लिए सुझाव:",
    "Ensure good lighting": "सुनिश्चित करें कि प्रकाश अच्छा हो",
    "Leaf should fill most of the frame": "पत्ती को फ्रेम का अधिकांश हिस्सा भरना चाहिए",
    "Avoid blurry or out-of-focus images": "धुंधली या आउट-ऑफ़-फ़ोकस छवियों से बचें",
    "Avoid heavily obstructed leaves": "भारी रूप से बाधित पत्तियों से बचें",
    "Screening not available": "स्क्रीनिंग उपलब्ध नहीं है",
    "Disease screening is not available for this crop yet.": "इस फसल के लिए रोग स्क्रीनिंग अभी उपलब्ध नहीं है।",
    "Invalid Image": "अमान्य छवि",
    "Please upload a valid crop image.": "कृपया एक वैध फसल छवि अपलोड करें।",
    "Analysis Unavailable": "विश्लेषण अनुपलब्ध",
    "Disease screening is temporarily unavailable.": "रोग स्क्रीनिंग अस्थायी रूप से अनुपलब्ध है।",
    "Try Again": "पुनः प्रयास करें",
    "Screening Result": "स्क्रीनिंग परिणाम",
    "Screen another leaf": "एक और पत्ती की जांच करें",
    "AI-assisted screening only. Results are not a confirmed diagnosis. For serious or uncertain cases, consult a local agricultural expert or KVK.": "केवल एआई-सहायता प्राप्त स्क्रीनिंग। परिणाम पक्के निदान नहीं हैं। गंभीर या अनिश्चित मामलों के लिए, किसी स्थानीय कृषि विशेषज्ञ या केवीके से सलाह लें।",
    "Get AI Disease Advisory": "एआई रोग सलाह प्राप्त करें",
    "Get AI Crop Health Advice": "एआई फसल स्वास्थ्य सलाह प्राप्त करें",
    "Generating Advisory...": "सलाह उत्पन्न हो रही है...",
    "AI advisory is unavailable because the disease screening result is uncertain.": "एआई सलाह अनुपलब्ध है क्योंकि रोग जांच परिणाम अनिश्चित है।",
    "AI disease advisory is temporarily unavailable.": "एआई रोग सलाह अस्थायी रूप से अनुपलब्ध है।",
    "AI Disease Advisory": "एआई रोग सलाह",
    "Summary": "सारांश",
    ...
    "Weather Considerations": "मौसम संबंधी विचार",
    "When to Seek Expert Help": "विशेषज्ञ की मदद कब लें",
    "Important Cautions": "महत्वपूर्ण सावधानियां"
  },
  mr: {
    "Home": "होम",
    ...
    "AI-Assisted Disease Screening": "एआय-सहाय्यित रोग स्क्रीनिंग",
    "Upload a clear photo of a crop leaf to screen for common diseases.": "सामान्य आजारांची तपासणी करण्यासाठी पिकाच्या पानाचा स्पष्ट फोटो अपलोड करा.",
    "Select Crop": "पीक निवडा",
    "Upload a leaf image": "पानाची प्रतिमा अपलोड करा",
    "JPG, PNG or WebP • Maximum 5 MB": "JPG, PNG किंवा WebP • कमाल 5 MB",
    "Analyze Crop": "पिकाचे विश्लेषण करा",
    "Analyzing...": "विश्लेषण करत आहे...",
    "Drag & drop image here or click to browse": "प्रतिमा येथे ड्रॅग आणि ड्रॉप करा किंवा ब्राउझ करण्यासाठी क्लिक करा",
    "Take a photo": "फोटो काढा",
    "Remove image": "प्रतिमा काढा",
    "Your image is analyzed for this screening request and is not stored by KrushiSense.": "आपली प्रतिमा या स्क्रीनिंग विनंतीसाठी विश्लेषित केली जाते आणि कृषीसेन्सद्वारे संग्रहित केली जात नाही.",
    "Please select a supported crop first.": "कृपया प्रथम समर्थित पीक निवडा.",
    "File size exceeds 5MB limit.": "फाईलचा आकार 5MB मर्यादेपेक्षा जास्त आहे.",
    "Invalid file type. Please upload a JPG, PNG or WebP image.": "अवैध फाईल प्रकार. कृपया JPG, PNG किंवा WebP प्रतिमा अपलोड करा.",
    "An error occurred during upload. Please try again.": "अपलोड करताना त्रुटी आली. कृपया पुन्हा प्रयत्न करा.",
    "Plant appears healthy": "वनस्पती निरोगी दिसते",
    "No common disease was detected by the screening model.": "स्क्रीनिंग मॉडेलला कोणताही सामान्य आजार आढळला नाही.",
    "Crop": "पीक",
    "Confidence": "खात्री",
    "Possible disease detected": "संभाव्य आजार आढळला",
    "AI screening indicates a possible case of": "एआय स्क्रीनिंग याच्या संभाव्य प्रकरणाचा संकेत देते:",
    "Disease": "आजार",
    "Unable to determine reliably": "विश्वसनीयपणे निर्धारित करण्यात अक्षम",
    "Please upload a clearer photo showing the affected leaf.": "कृपया प्रभावित पान दर्शवणारा अधिक स्पष्ट फोटो अपलोड करा.",
    "Suggestions for better results:": "उत्तम परिणामांसाठी सूचना:",
    "Ensure good lighting": "चांगला प्रकाश असल्याची खात्री करा",
    "Leaf should fill most of the frame": "पानाने फ्रेमचा बहुतांश भाग व्यापला पाहिजे",
    "Avoid blurry or out-of-focus images": "अस्पष्ट किंवा आऊट-ऑफ-फोकस प्रतिमा टाळा",
    "Avoid heavily obstructed leaves": "अडथळा असलेली पाने टाळा",
    "Screening not available": "स्क्रीनिंग उपलब्ध नाही",
    "Disease screening is not available for this crop yet.": "या पिकासाठी रोग स्क्रीनिंग अद्याप उपलब्ध नाही.",
    "Invalid Image": "अवैध प्रतिमा",
    "Please upload a valid crop image.": "कृपया वैध पीक प्रतिमा अपलोड करा.",
    "Analysis Unavailable": "विश्लेषण अनुपलब्ध",
    "Disease screening is temporarily unavailable.": "रोग स्क्रीनिंग तात्पुरते अनुपलब्ध आहे.",
    "Try Again": "पुन्हा प्रयत्न करा",
    "Screening Result": "स्क्रीनिंग निकाल",
    "Screen another leaf": "दुसऱ्या पानाची तपासणी करा",
    "AI-assisted screening only. Results are not a confirmed diagnosis. For serious or uncertain cases, consult a local agricultural expert or KVK.": "केवळ एआय-सहाय्यित स्क्रीनिंग. निकाल पक्के निदान नाहीत. गंभीर किंवा अनिश्चित प्रकरणांसाठी, स्थानिक कृषी तज्ञाचा किंवा केव्हीकेचा सल्ला घ्या.",
    "Get AI Disease Advisory": "एआय रोग सल्ला मिळवा",
    "Get AI Crop Health Advice": "एआय पीक आरोग्य सल्ला मिळवा",
    "Generating Advisory...": "सल्ला तयार करत आहे...",
    "AI advisory is unavailable because the disease screening result is uncertain.": "रोग तपासणीचा निकाल अनिश्चित असल्यामुळे एआय सल्ला अनुपलब्ध आहे.",
    "AI disease advisory is temporarily unavailable.": "एआय रोग सल्ला तात्पुरता अनुपलब्ध आहे.",
    "AI Disease Advisory": "एआय रोग सल्ला",
    "Summary": "सारांश",
    "What This Means": "याचा अर्थ काय",
    "Symptoms": "लक्षणे",
    "Immediate Actions": "तात्काळ कृती",
    "Prevention": "प्रतिबंध",
    "Sustainable Practices": "शाश्वत पद्धती",
    "Weather Considerations": "हवामानाचा विचार",
    "When to Seek Expert Help": "तज्ञांची मदत कधी घ्यावी",
    "Important Cautions": "महत्त्वाच्या सावधगिरी"
  }
};
